        ...
        <div class="flex min-h-screen overflow-y-auto">
            ...
            <div class="w-full bg-#e0e0e2 font-inter lg:w-1/2 flex items-center justify-center">
                <div class="max-w-md w-full p-5 lg:p-0 animate-fade_in">
                    ...
                    <!-- tabs -->
                    <div class="flex justify-center mb-5 border-b border-gray-300">
                        <a href="{{ url('/manager_sign_up_form') }}" class="px-4 py-2 text-sm font-medium text-center {{ request()->is('manager_sign_up') ? 'text-black border-b-2 border-black' : 'text-gray-500' }}">
                            Manager Sign Up
                        </a>
                        <a href="{{ url('/member_sign_up_form') }}" class="px-4 py-2 text-sm font-medium text-center {{ request()->is('member_sign_up') ? 'text-black border-b-2 border-black' : 'text-black-500 font-semibold border-b-2 border-black' }}">
                            Member Sign Up
                        </a>
                    </div>
                    
                    <h1 class="text-3xl font-bold mb-1 text-black">Get started now</h1>
                    <h1 class="text-l font-semibold mb-7 text-black-500">Create a new account as a member.</h1>
                    
                    <form action="{{ url('/member_sign_up_process') }}" method="POST" class="space-y-3">
                    @csrf
