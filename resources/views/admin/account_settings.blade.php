                    ...
                    <div class="p-8">
                        @isset($info)
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-black text-lg font-semibold" id="user_last_name">{{ $info->middle_name }}</p>
                            </div>
                            <div class="mt-4">
            ...
            <div class="w-full lg:w-1/2 lg:pl-2">
                <div class="bg-[#ececec] border border-[#cdcdcd] rounded-lg shadow-xl min-h-screen p-4">
                    <div class="p-8">
                        ...
                        <form action="{{ url('/update_admin_account_settings') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
