...
<html>
    ...
    <body class="">
        <header class="font-inter fixed top-0 left-0 w-full bg-#e0e0e2 bg-opacity-80 py-3 border-b-header-stroke border-black border-opacity-20 z-10 backdrop-blur">
            <div class="flex items-center justify-between px-6">
                ...
                <div class="relative">
                    @isset($info)
                        <span class="text-black text-sm font-semibold bg-#cdcdcd-50 px-2.5 py-1 rounded-full">Administrator</span>
                    @endisset
                </div>
            </div>
        </header>
