...
<body class="bg-[#e0e0e2]">
    ...
    <div class="pb-16 animate-fade_in">
        ...
        <div class="flex flex-wrap justify-center px-9 mt-7 font-inter">
            ...
            <div class="w-full lg:w-1/2 lg:pl-2 flex flex-col">
                <div class="bg-[#ececec] border border-[#cdcdcd] rounded-lg shadow-xl min-h-screen p-4 flex-1">
                    <div class="p-8">
                        ...
                        <form action="{{ url('/update_member_account_settings') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full sm:w-1/2 px-2">
                                    ...
                                    <input type="text" id="middlename" name="middlename_" value="{{ old('middlename_', $info->middle_name) }}" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#171717] sm:text-sm placeholder-[#828282]-50 bg-[#f4f4f4]">
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-2 mt-6">
                                ...
                                <div class="w-full sm:w-3/5 px-2">
                                    ...
                                    <input type="text" id="organizationsname" name="organizationsname_" value="{{ old('organizationsname_', $info->organizations_name) }}" required readonly class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#171717] sm:text-sm placeholder-[#828282]-50 bg-[#f4f4f4]">
                                </div>
                            </div>
                            <div class="mt-6">
